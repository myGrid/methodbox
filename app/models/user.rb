...
class User < ActiveRecord::Base
  ...
  validates_presence_of     :password,                   :unless => :shibboleth
  validates_presence_of     :password_confirmation,      :unless => :shibboleth
  validates_length_of       :password, :within => 4..40, :unless => :shibboleth
  validates_confirmation_of :password,                   :unless => :shibboleth
