class VariablesController < ApplicationController
  ...
  def values_array
    ...
    variable.to_json(:include => { :value_domains => {:include => :value_domain_statistic}})
    respond_to do |format|
      format.html
      format.xml  { render :xml => variables_hash}
      format.json  { render :json => variable.to_json(:include => { :value_domains => {:include => :value_domain_statistic}})}
    end
  end
