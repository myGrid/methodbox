ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :csvarchives, :member => {:download => :get, :thumbs_up => :post, :thumbs_down => :post }, :collection =>{:recreate => :post, :help => :get, :help2 => :get,:show_links=>:post, :check_for_complete => :post }, :requirements => {:protocol => 'http'}
