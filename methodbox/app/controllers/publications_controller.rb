class PublicationsController < ApplicationController
  ...
  def edit
    #This is necessary due to weirdness with acts_as_resource - not important to mb at the moment
  ...
  #Try and relate non_seek_authors to people in MethodBox based on name (no projects in MB at the moment)
